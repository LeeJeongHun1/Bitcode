...
<%--                            <c:forEach var="i" items="${list.list}">
    ...
    <nav style="text-align:center;"><ul class="pagination"></ul></nav>
...
<select style="margin-left:395px;width:121px;margin-top:12px;height: 35px;
    ...
    line-height: 29px;" name="type">
        ...
        <option value="code">분류</option>
            ...
            <button class="btn btn-primary" type="button" onclick="location.href='insertForm.do'" style="position:absolute;right:100px; bottom:14px;">글쓰기</button></div>
